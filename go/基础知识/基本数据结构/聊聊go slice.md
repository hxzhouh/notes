...
package main
import (    "fmt")
func main() {    var array [10]int
    var slice = array[5:6]
    fmt.Println("lenth of slice: ", len(slice))    fmt.Println("capacity of slice: ", cap(slice))    fmt.Println(&slice[0] == &array[5])}
```
...
![img](https://gblobscdn.gitbook.com/assets%2F-LQm0KQP9eyG1B9ntPkR%2F-LQrwPNEfpJaP10emjSq%2F-LQrwR-o_Vkr6b1yoC3_%2Fslice-01-make_slice.png?generation=1541758108922841&alt=media)
...
![img](https://gblobscdn.gitbook.com/assets%2F-LQm0KQP9eyG1B9ntPkR%2F-LQrwPNEfpJaP10emjSq%2F-LQrwR-qRahCbfgVZAkK%2Fslice-02-create_slice_from_array.png?generation=1541758108888293&alt=media)
...
![img](https://gblobscdn.gitbook.com/assets%2F-LQm0KQP9eyG1B9ntPkR%2F-LQrwPNEfpJaP10emjSq%2F-LQrwR-s8eHSiBH7snpX%2Fslice-03-slice_expand.png?generation=1541758108870420&alt=media)
